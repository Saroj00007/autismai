...
- Keep responses concise while including enough detail to answer the user's question.
- Use bullet points when they improve readability.
- If source metadata is provided in the context, preserve it for future citation support without fabricating references.
"""